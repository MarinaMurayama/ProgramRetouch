...
public class ItemSearchResult extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			int pageNum = Integer.parseInt(request.getParameter("page_num") == null ? "1" : request.getParameter("page_num")); //null(true)だったら1㌻目
			...
			//総アイテム数
			request.setAttribute("itemCount", (int) itemCount); //double型からintへキャスト
			// 総ページ数
